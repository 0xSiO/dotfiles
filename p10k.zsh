# Generated by Powerlevel10k configuration wizard on 2025-05-02 at 13:42 PDT.
...
() {
  ...
  # Green prompt symbol if the last command failed.
  ...
  # Format for the current time: 9:51:02. See `man 3 strftime`.
